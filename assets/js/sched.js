function calculateTimeUntil(targetDay, targetHour, targetMinute) {
    ...
    if (daysUntilTarget === 0 && currentDate.getHours() > targetHour) daysUntilTarget = 7;
...
function updateSchedules() {
    const schedule = [
        ...
        { day: 1, hour: 15, minute: 0 },    // Monday       3:00 PM     5
        { day: 2, hour: 8,  minute: 0 },    // Tuesday      8:00 AM     6
        { day: 2, hour: 10, minute: 0 },    // Tuesday      10:00 AM    7
        { day: 2, hour: 14, minute: 0 },    // Tuesday      2:00 PM     8
        { day: 3, hour: 9,  minute: 0 },    // Wednesday    9:00 AM     9
        { day: 3, hour: 10, minute: 0 },    // Wednesday    10:00 PM    10
        { day: 3, hour: 13, minute: 0 },    // Wednesday    1:00 PM     11
        { day: 4, hour: 8,  minute: 0 },    // Thursday     10:00 AM    12
        { day: 4, hour: 10, minute: 0 },    // Thursday     10:00 AM    13
        { day: 6, hour: 8,  minute: 0 }     // Saturday     8:00 AM     14
    ];
    ...
    for (let i = 0; i < schedule.length; i++) {
        ...
        if (eventTime >= 0) {
            ...
            if (days === 0) daysText = "Day";
            if (hours === 0) hoursText = "Hour";
            if (minutes === 0) minutesText = "Minute";
            if (seconds === 0) secondsText = "Second";
